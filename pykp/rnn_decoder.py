...
class RNNDecoder(nn.Module):
    ...
    def forward(self, y, h, memory_bank, src_mask, max_num_oovs, src_oov, coverage):
        """
        :param y: [batch_size]
...
if __name__ == '__main__':
    ...
    max_num_oovs = 3
    final_dist, h_next, context, attn_dist, p_gen, coverage = decoder(y, h, memory_bank, src_mask, max_num_oovs, input_seq_oov, coverage)
    print("Pass")
